    ...
    public:
        ...
        class iterator {
            public:
                ...
                // operateurs
                iterator & operator++() { // incrémentation prefixe
                    this->position++;
                    return *this;
                }
                iterator operator++(int) { // incrémentation postfixe
                    iterator i = *this; // on mémorise la position de l'itérateur
        ...
        iterator begin() noexcept {
            return iterator(this->mat);
        }
        iterator end() noexcept {
            return iterator(this->mat + size);
        }
